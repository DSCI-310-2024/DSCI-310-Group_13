...
![Brand distribution](../visualisations/Graph6.png){#fig-brand-distribution width=90%}
![Barplot b/w Price and processor_brand](../visualisations/Graph7.png){#fig-barplot-processor-brand width=90%}
![Distribution of all numeric variables](../visualisations/Graph2.png){#fig-distribution-numeric width=90%}
![Distribution of all variables](../visualisations/Graph3.png){#fig-distribution-all width=90%}
...
![Outliers](../visualisations/Graph4.png){#fig-outliers width=90%}


# 7. Correlation analysis

![Correlation matrix](../visualisations/Graph4.png){#fig-correlation-matrix width=90%}
