...
![Distribution of laptop prices.](../visualization/Graph1.png){#fig-distribution-of-laptop-prices width=60%}
...
![Brand distribution](../visualization/Graph6.png){#fig-brand-distribution width=50%}
...
![Barplot b/w Price and processor_brand](../visualization/Graph7.png){#fig-barplot-processor-brand width=50%}
...
![Distribution of all numeric variables](../visualization/Graph2.png){#fig-distribution-numeric width=70%}


![Distribution of all variables](../visualization/Graph3.png){#fig-distribution-all width=70%}
...
![Outliers](../visualization/Graph4.png){#fig-outliers width=50%}


## 7. Correlation analysis

![Correlation matrix](../visualization/Graph4.png){#fig-correlation-matrix width=50%}
...
![Coefficients of Independent Variables](../visualization/Graph8.png){#fig-coefficients width=90%}
