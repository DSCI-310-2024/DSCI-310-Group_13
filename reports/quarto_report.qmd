...
![Distribution of all numeric variables](../visualisations/Graph2.png){#fig-distribution-numeric width=50%}
![Distribution of all variables](../visualisations/Graph3.png){#fig-distribution-all width=50%}
@fig-brand-distribution
